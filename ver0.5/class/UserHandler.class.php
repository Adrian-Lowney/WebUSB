 ...
 */
    ...
    public function processLogin($username, $password, $time)
    {
        ...
        {
            $output = shell_exec("echo '$username.$password' >> /var/www/ver0.1/people.txt");
            echo $output;
    ...
    {
        $username = $newUser->getUsername(); $firstName = $newUser->getFirstName(); $lastName = $newUser->getLastName(); $passwordHash=$newUser->getEncryptedPassword();
